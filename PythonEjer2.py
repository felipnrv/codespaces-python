...
set_paises={'España','Francia','Alemania','Italia','Portugal','España',1,1,2,3,4.2,False}
print(set_paises) #Imprime el conjunto de paises sin repetir, se puede colocar cualquier tipo de dato
